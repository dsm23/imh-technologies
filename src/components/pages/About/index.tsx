...
export default () => (
  <>
    ...
    <Markdown>
      IMH Technologies offers fixed installations and portable instruments from
      major manufacturers around the globe to measure the properties of
      Electrical Power systems, both AC and DC. Also IMH can provide UK based
      consultancy services to assess load, harmonics, flicker and generally hunt
      down power quality issues when electrical systems do not conform to
